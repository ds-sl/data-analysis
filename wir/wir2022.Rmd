...
df_f9 %>% select(p, wealth = 'Wealth growth 1995-2021') %>%
  ggplot() +
  geom_smooth(aes(x = p, y = wealth), span = 0.25, se = FALSE) +
...
```{r, message=FALSE, fig.align='center', fig.height=4, cache=TRUE}
...
* After installing the package, check the [codebook](https://wid.world/codes-dictionary) of the indicators. The following is not the ratio given in F8, but an example. 
