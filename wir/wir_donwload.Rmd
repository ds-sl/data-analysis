...
> _This document is recompiled and uploaded because the link to the original document is broken._
...
download_wid(
    ...
    include_extrapolations # Logical: should it include data based on 
